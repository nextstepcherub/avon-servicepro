  ...
  const menuCategories: MenuCategorySpec[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'com-po', label: 'Purchase Orders (PO)', targetTab: 'service', rolesAllowed: ['Workshop Manager', 'Documentation Officer', 'Senior Biomedical Engineer', 'Senior Service Engineer'] },
